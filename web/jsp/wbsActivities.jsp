...
<%@ include file="pcURL.jspf" %>
    ...
    <ul class="nav nav-tabs responsive hidden-xs hidden-sm" role="tablist" id="tabs-0">
      ...
      <li class="nav-item"><a class="nav-link active tabactive" data-toggle="tab" href="javascript:alert('Occorre selezionare una WBS per indicarne le attivit&agrave;')" id="show_act">Attivit&agrave;</a></li>
